...
Background:
	Given the following Kanban boards
		| Title		   | User		| Number of times favorited | Date posted | Thumbnail picture path			 |
...
Scenario: See the 3 most favorited kanban boards
	When I to to the homepage
	Then I should see the following Kanban boards as the most favorited:
		| Title		   | User		| Number of times favorited | Date posted | Thumbnail picture path			 |
		| Kanban 1     | David		| 1000						| 2010-04-01  | /thumbnails/kanban1_thumb.jpg	 |
		| Demo 2       | Joakim		| 300						| 2010-06-01  | /thumbnails/demo2_thumb.jpg		 |
		| Demo 1       | Marcus		| 100						| 2010-01-01  | /thumbnails/demo1_thumb.jpg		 |
